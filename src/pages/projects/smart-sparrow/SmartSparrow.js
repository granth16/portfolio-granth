...
const description =
  'I worked as the developer lead on a major iteration of Smart Sparrow’s product. We took the platform in a bold new direction, focusing on becoming the best tool for learning designers.';
const roles = [
      ...
      <ProjectContainer className="spr">
        ...
        <ProjectSection light={isDark}>
          <ProjectSectionContent>
            ...
            <ProjectTextRow>
              ...
              <ProjectSectionText>
                To streamline the development process across designers and engineers for
                such a large project, it was important to lay the foundations with a
                strong, flexible development system that could evolve during the product’s
                development cycle. This would inform both the aesthetics and user
                experience across the product itself as well as the website and marketing
                material.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        ...
        <ProjectSection>
          <ProjectSectionContent>
            ...
            />
            <ProjectTextRow>
              <ProjectSectionHeading>Development system docs</ProjectSectionHeading>
              <ProjectSectionText>
                A development system is useless if no one knows how to use it, so we put
              ...
              <ProjectSection>
                <ProjectSectionContent width="xl">
                  <ProjectTextRow justify="end" width="s">
                    ...
                    <ProjectSectionText>
                      One really cool example is the 3D screen plugin. Learning developers
              ...
              <ProjectSection>
                <ProjectSectionContent width="xl">
                  <ProjectTextRow justify="end" width="s">
                    ...
                    <ProjectSectionText>
                      Learning developers can pick an animation included in the model to
